        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="index.php" class="d-flex nav_link active">
                    ...
                    <a href="taikhoan.php" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <a href="loaihang.php" class="d-flex nav_link">
                    ...
                    <a href="donhang.php" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <a href="sanpham.php" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <a href="baocao.php" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <a href="khachhang.php" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
