        ...
        <div class="container p-5">
            <div class="mt-5 ms-3 row">
                <div class="ms-5 pt-5 col-md-6">
                    <p style="font-size:50px;color:#f7b400;font-family:'Arial'" class="fw-bolder mt-5 ms-5">CSE481</p>
                    <p style="font-family:'Arial'" class="fs-3 ms-5">CSE481 giúp bạn trở nên hoàn mỹ hơn.</p>
